  ...
  var
    ...
    chat = (function () {
      ...
      _update_list = function ( arg_list ) {
        ...
        for ( i=0; i < people_list.length; i++ ) {
          ...
          if ( stateMap.user && stateMap.user.id === person_map.id ) {
            stateMap.css_map = person_map.css_map;
            continue PERSON;
          }
        ...
        //if chatee is no longer online, we enset the chatee
        //which triggers the 'spa-setchatee' global event
        if ( chatee && ! is_chatee_online ) { set_chatee(""); }
      };

      _publish_list_change = function ( arg_list ) {
      ...
      join_chat = function () {
        ...
        sio.on( 'listchange', _publish_list_change );
      ...
      send_msg = function ( msg_text ) {
        ...
        //we published updatechat se we can show our outgoing messages
